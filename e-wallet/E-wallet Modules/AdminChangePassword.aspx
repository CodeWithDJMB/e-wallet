<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminChangePassword.aspx.cs" Inherits="E_wallet.E_wallet_Modules.AdminChangePassword" %>
    ...
    <form id="form1" runat="server">
        <div>   
           <div class="admin-left-divs">
               ...
               <h1 style="text-align:center;">Please complete the required fields.</h1><br />
               <h3 class="h3-admin-notes">Once you have finished changing your password, simply click the "Finish" button.<br /> <br /> <br /> 
              </h3>       
              <asp:Button ID="btnChangePswrdFinish" CssClass="admin-buttons" OnClick="btnChangePswrdFinish_Click" runat="server" Text="Finish" Height="53px" Width="170px"/>   
              &nbsp;&nbsp;&nbsp;&nbsp;   
              <asp:Button ID="btnChangePswrdBack" CssClass="admin-buttons" OnClick="btnChangePswrdBack_Click" runat="server" Text="Back" Height="53px" Width="170px"/>  
              </center>
           </div>
               <div class="admin-right-divs"><br />
                <center>            
                    <p class="p-admin-headers">Change your password</p><br /><br />
                    Account Number:&nbsp;&nbsp;
