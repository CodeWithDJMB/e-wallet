<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSignUp.aspx.cs" Inherits="E_wallet.E_wallet_Modules.AdminSignUp" %>
    ...
    <form id="form1" runat="server">
         <div>   
           <div class="admin-left-divs">
               ...
               <h3 class="h3-admin-notes">Once you have finished filling out the form, simply click the "Finish" button to create your account.<br /> <br />
              </h3>       
              <asp:Button ID="btnCreateAccFinish" CssClass="admin-buttons" OnClick="btnCreateAccFinish_Click" runat="server" Text="Finish" Height="53px" Width="170px"/>   
              &nbsp;&nbsp;&nbsp;&nbsp;   
              <asp:Button ID="btnCreateAccBack" CssClass="admin-buttons" OnClick="btnCreateAccBack_Click" runat="server" Text="Back" Height="53px" Width="170px"/>  
              </center>
           </div>
               <div class="admin-right-divs"><br />
                   <center>
                   <p class="p-admin-headers">Create Your Account</p>
                   First Name:&nbsp;&nbsp;
                  <asp:TextBox ID="txtCrtFname" MaxLength="70" runat="server" Width="250px" Height="25px"></asp:TextBox>
                   ...
                   <asp:TextBox ID="txtCnfrmCrtPswrd" MaxLength="70" TextMode="Password" runat="server" Width="440px" Height="25px" CssClass="auto-style272"></asp:TextBox><br />                   
                    ...
                    <asp:RegularExpressionValidator ID="revCntrInvldInptMidIntl" runat="server" ControlToValidate="txtCrtMidIntl"
                    ...
                    <asp:RegularExpressionValidator ID="revCntrInvldInptBrthDt" runat="server" ControlToValidate="txtCrtBirthDt"
                   ...
                   <%-- Invalid format input for Phone Number --%>
                    <asp:RegularExpressionValidator ID="revCntrInvldInptPhNo" runat="server" ControlToValidate="txtCrtPhNum"
                  ...
                  <%-- Invalid format input for Email Address --%>
                    <asp:RegularExpressionValidator ID="revCntrInvldInptEmlAdrs" runat="server" ControlToValidate="txtCrtEmlAdrs"
