<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientWithdraw.aspx.cs" Inherits="E_wallet.E_wallet_Modules.Withdraw" %>
       ...
       <div>
            ...
            <div class="client-right-divs">
                ...
                <center>
                    ...
                    <p class="p-client-headers">Withdraw your money</p><br /><br /><br />
                    <div class="div-transaction-fields">
                        ₱&nbsp
                            <asp:TextBox ID="txtWthdrwMoney" CssClass="transaction-textboxes" AutoPostBack="true" runat="server" Font-Size="23" Font-Bold="true"  placeholder="Enter amount" OnTextChanged="txtWthdrwMoney_TextChanged"  Width="260px" Height="61px"></asp:TextBox><br /><br /><br />
                        <asp:Label ID="lblWthdrwAmntInvalid" CssClass="label-invalid-transaction-amounts" runat="server" Text=""></asp:Label><br />  
                    </div><br /><br />                                                            
                    <asp:Button ID="btnWthdrwMny" CssClass="client-buttons" OnClick="btnWthdrwMny_Click" runat="server" Text="Withdraw" Height="53px" Width="170px"/><br /><br /><br />
                    </center>
            </div>
        </div>
    </form>
