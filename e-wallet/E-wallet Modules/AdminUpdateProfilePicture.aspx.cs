...
{
    public partial class AdminUpdateProfilePicture : System.Web.UI.Page
    {
        ...
        protected void btnUpdtPrflFinish_Click(object sender, EventArgs e)
        {
            ...
            using (var db = new SqlConnection(connStr))
            {
                ...
                using (var cmd = db.CreateCommand())
                {
                    ...
                    cmd.CommandText = "UPDATE ADMIN_TBL SET ADMIN_PROFPIC = @imageBytes WHERE ADMIN_USRNME = @username";
